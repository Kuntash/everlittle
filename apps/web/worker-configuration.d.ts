/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b81870522ce6d40bde5ef4cca8a0f47b)
// Runtime types generated with workerd@1.20260730.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	APP_NAME: "Everlittle" | "Everlittle Sandbox";
	DEPLOYMENT_MODE: "hosted" | "self-hosted";
	INVITATION_FROM_EMAIL: "invites@geteverlittle.com" | "invites@example.com";
	PUBLIC_APP_URL: "https://geteverlittle.com" | "https://everlittle-sandbox.kuntashtashi11.workers.dev" | "http://localhost:3000";
	DODO_PAYMENTS_ENVIRONMENT: "live_mode" | "test_mode";
	POSTHOG_PROJECT_TOKEN?: "phc_moqXcBVhKD9oP7YiYRbHng47QXcjPyZbStYWdHpLTPVu";
	POSTHOG_HOST?: "https://eu.i.posthog.com";
	BETTER_AUTH_SECRET: string;
	CHILD_PIN_PEPPER: string;
}
declare namespace Cloudflare {
	...
	interface HostedEnv {
		...
		INVITATION_FROM_EMAIL: "invites@geteverlittle.com";
	...
	interface SandboxEnv {
		...
		DB: D1Database;
		EMAIL: SendEmail;
		APP_NAME: "Everlittle Sandbox";
		DEPLOYMENT_MODE: "hosted";
		INVITATION_FROM_EMAIL: "invites@geteverlittle.com";
		PUBLIC_APP_URL: "https://everlittle-sandbox.kuntashtashi11.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "DEPLOYMENT_MODE" | "INVITATION_FROM_EMAIL" | "PUBLIC_APP_URL" | "DODO_PAYMENTS_ENVIRONMENT" | "POSTHOG_PROJECT_TOKEN" | "POSTHOG_HOST" | "BETTER_AUTH_SECRET" | "CHILD_PIN_PEPPER">> {}
}
